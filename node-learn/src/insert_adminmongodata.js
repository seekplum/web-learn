...
async function getUsers() {
  ...
  while (page < totalPage) {
    page += 1;
    const url = `http://adminmongo.dev.xxx.net/api/mongo/xxxdb/user/${page}`;
...
async function insertUsers(nicks) {
  const url = 'http://adminmongo.dev.xxx.net/document/xxxdb_survey/xxxdb_survey/survey/insert_doc';
